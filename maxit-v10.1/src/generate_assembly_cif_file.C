/*
FILE:     generate_assembly_cif_file.C
*/
/*
VERSION:  11.200
*/
...
int main(int argc, char **argv)
{
       ...
       std::string inputfile, filename_prefix, indexfile;
       inputfile.clear();
       filename_prefix.clear();
       indexfile.clear();

       bool public_flag = true;
       bool single_model_flag = true;
       ...
       if (inputfile.empty() || filename_prefix.empty()) {
            usage(argv[0], logutil);
            logutil.close();
            return (1);
       }
       ...
       indexfile = filename_prefix + ".output.list";
       ...
       try {
            ...
            obj.AssignEntityId();
            obj.AssignAsymId();
            obj.write_biological_cif_files(filename_prefix, indexfile, public_flag, single_model_flag);
...
static void usage(const std::string& program, LogUtil& logutil)
{
       std::string log = "Usage: " + program + " -input input_ciffile -output output_file_name_prefix\n";
