...
POSSIBILITY THEREOF. 
*/
#ifndef _H_CONNECTFORMAT_GLOBAL_H_
#define _H_CONNECTFORMAT_GLOBAL_H_

#define NUM_CHEM_COMP         24

static const char *_chem_comp[NUM_CHEM_COMP] = {
       "id",
       "name",
       "type",
       "pdbx_type",
...
const char *_chem_comp_atom[NUM_CHEM_COMP_ATOM] = {
       "atom_id",                  // index  0
       "alt_atom_id",              // index  1
       "type_symbol",              // index  2
       "charge",                   // index  3
...
const char *_output_chem_comp_atom[NUM_CHEM_COMP_ATOM] = {
       "atom_id",                  // index  0
       "alt_atom_id",              // index  1
       "type_symbol",              // index  2
       "charge",                   // index  3
...
static const char *_chem_comp_atom_varient[NUM_CHEM_COMP_ATOM] = {
       "atom_id",                  // index  0
       "alt_atom_id",              // index  1
       "type_symbol",              // index  2
       "charge",                   // index  3
...
const char *_chem_comp_bond[NUM_CHEM_COMP_BOND + 2] = {
       "atom_id_1",
       "atom_id_2",
       "value_order",
       "pdbx_aromatic_flag",
...
const char *_chem_comp_bond_varient[NUM_CHEM_COMP_BOND + 2] = {
       "atom_id_1",
       "atom_id_2",
       "type",
       "pdbx_aromatic_flag",
